...
const themes = ["Modern", "Vintage", "Minimalist", "Professional","Tropical","Coastal","Vintage","Industrial","Neoclassic","Tribal"];
const rooms = ["Living Room", "Dining Room", "Bedroom", "Bathroom", "Office", "Kitchen","Basement","Arabina Majilis","Outdoor Patio","Gaming Room"];
        ...
        <div className="sm:flex sm:items-start sm:justify-between">
          <div>
            ...
            <div className="mt-5 max-w-xl text-m text-gray-500">
              <p>
              Încarăcați o imagine a camerei dvs. ce doriți să o îmbunătățiți
              </p>
            </div>
          </div>
...
export default function HomePage() {
  ...
  function onImageDrop(acceptedFiles: File[], rejectedFiles: FileRejection[]) {
    ...
    if (rejectedFiles.length > 0) {
      ...
      setError("Vă rugăm să încărcați o poză cu o mărime mai mică de 5MB.");
      return;
    }
  ...
  async function submitImage() {
    if (!file) {
      setError("Vă rugăm să încărcați o imagine.");
      return;
    }
  ...
  return (
    <main className="flex min-h-screen flex-col py-10 lg:pl-72">
      ...
      <section className="mt-10 grid flex-1 gap-6 px-4 lg:px-6 xl:grid-cols-2 xl:gap-8 xl:px-8">
        ...
        <ImageOutput
          title={`Camera stilizată de AI va apărea aici`}
